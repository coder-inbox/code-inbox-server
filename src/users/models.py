...
class User(Model):
    ...
    full_name: Optional[str] = Field(index=True, description="Full name of the user.")
    ...
    profile_picture: Optional[str] = Field(default="", description="URL to the user's profile picture.")
    phone_number: Optional[str] = Field(default="", description="User's phone number.")
    calendar: Optional[str] = Field(default="", description="User's calendar ID.")
    user_status: Optional[UserStatus] = Field(default=UserStatus.ACTIVE.value, description="User's status.")
    user_role: Optional[UserRole] = Field(default=UserRole.REGULAR.value, description="User's role.")
    creation_date: Optional[datetime] = Field(default_factory=datetime.utcnow, description="User's creation date.")
    modified_date: Optional[datetime] = Field(default_factory=datetime.utcnow, description="User's last modification date.")
